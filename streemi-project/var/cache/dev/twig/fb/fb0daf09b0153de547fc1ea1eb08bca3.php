...
/* admin.html.twig */
class __TwigTemplate_074d70971c0799b761416824f07753c2 extends Template
{
    ...
    <main class=\" flex-1 py-10  px-5 sm:px-10 \">
        ...
        <section>
            ...
            <div class=\"mt-4 grid grid-cols-2 gap-y-5 sm:grid-cols-3 gap-x-5\">
                <a href=\"admin_films.html\" class=\"relative flex flex-col items-center justify-center rounded-xl overflow-hidden aspect-square border hover:scale-105 cursor-pointer transition hover:bg-gray-100\">
                ...
                <a href=\"admin_users.html\" class=\"relative flex flex-col items-center justify-center rounded-xl overflow-hidden aspect-square border hover:scale-105 cursor-pointer transition hover:bg-gray-100\">
                    <span class=\"text-red-600 font-bold mb-4\">
                ...
                <a href=\"upload.html\" class=\"relative flex flex-col items-center justify-center rounded-xl overflow-hidden aspect-square border hover:scale-105 cursor-pointer transition hover:bg-gray-100\">
                    <span class=\"text-red-600 font-bold mb-4\">
...
", "admin.html.twig", "/Users/alexis/Documents/EEMI-cours/Master1/Framework Symfony/streemi-tp-symfony/streemi-project/templates/admin.html.twig");
    }
}
